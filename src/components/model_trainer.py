...
class ModelTrainer:
    def __init__(self):
        ...
        self.models = {
                        ...
                        'GrandientBoostingClassifier':GradientBoostingClassifier(),
                        'SVC': SVC(),
    ...
    def get_best_model(self,
        ...
        try:
            ...
            best_model_objest = self.models[best_model_name]




            return best_model_name, best_model_objest, best_model_score
